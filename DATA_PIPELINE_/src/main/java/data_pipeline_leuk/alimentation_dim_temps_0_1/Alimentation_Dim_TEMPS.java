...
package data_pipeline_leuk.alimentation_dim_temps_0_1;
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:4zRs64yHStaw0xuBv4gJtQPrgvquxHeAETYE9q9269Zwl7UGPXiY11sK");
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:RAeE5DKeROjgoxHHWiqDecusngchgbwO77q0957tnHARWoHgJF0=");
...
public static class out2Struct implements routines.system.IPersistableRow<out2Struct> {
    final static byte[] commonByteArrayLock_DATA_PIPELINE_LEUK_Alimentation_Dim_TEMPS = new byte[0];
    static byte[] commonByteArray_DATA_PIPELINE_LEUK_Alimentation_Dim_TEMPS = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DATA_PIPELINE_LEUK_Alimentation_Dim_TEMPS.length) {
				if(length < 1024 && commonByteArray_DATA_PIPELINE_LEUK_Alimentation_Dim_TEMPS.length == 0) {
   					commonByteArray_DATA_PIPELINE_LEUK_Alimentation_Dim_TEMPS = new byte[1024];
				} else {
   					commonByteArray_DATA_PIPELINE_LEUK_Alimentation_Dim_TEMPS = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DATA_PIPELINE_LEUK_Alimentation_Dim_TEMPS, 0, length);
			strReturn = new String(commonByteArray_DATA_PIPELINE_LEUK_Alimentation_Dim_TEMPS, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_DATA_PIPELINE_LEUK_Alimentation_Dim_TEMPS, 0, length);
			strReturn = new String(commonByteArray_DATA_PIPELINE_LEUK_Alimentation_Dim_TEMPS, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DATA_PIPELINE_LEUK_Alimentation_Dim_TEMPS) {
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
    ...
    static byte[] commonByteArray_DATA_PIPELINE_LEUK_Alimentation_Dim_TEMPS = new byte[0];
			    ...
			    public int Numero_Mois;

				public int getNumero_Mois () {
					return this.Numero_Mois;
				}
			    ...
			    public int Numero_Jour_Semaine;

				public int getNumero_Jour_Semaine () {
					return this.Numero_Jour_Semaine;
				}
			    ...
			    public String Numero_Semaine_Annee;

				public String getNumero_Semaine_Annee () {
					return this.Numero_Semaine_Annee;
				}
		...
		synchronized(commonByteArrayLock_DATA_PIPELINE_LEUK_Alimentation_Dim_TEMPS) {
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.Numero_Mois = dis.readInt();
					
					this.Nom_Mois = readString(dis);
					
					this.Mois_Annee = readString(dis);
					
			        this.Numero_Jour_Semaine = dis.readInt();
					
					this.Jour_Semaine = readString(dis);
					
					this.Numero_Semaine_Annee = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// int
		            	...
		            	dos.writeInt(this.Numero_Jour_Semaine);
					...
					// String
						...
						writeString(this.Numero_Semaine_Annee,dos);
    ...
    public String toString() {
		...
		sb.append(",Numero_Jour_Semaine="+String.valueOf(Numero_Jour_Semaine));
		sb.append(",Jour_Semaine="+Jour_Semaine);
		sb.append(",Numero_Semaine_Annee="+Numero_Semaine_Annee);
		sb.append(",Trimestre="+Trimestre);
		sb.append(",Semestre="+Semestre);
	    sb.append("]");
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:qjg4/m6i5WSlBVebNQZFv2aQa6xBZiELWyrTlX9gwawHAWqpEW67zIPz");
...
+"- INTERVAL'1 day'  \n--ORDER BY  \"public\".\"sales\".\"date\" asc";
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:zU9sBiRFjbf3NiJNcr5t+a90tq9UmHlWNLXU1ZiRr/kGL/4ewkw=");
...
row3 = null;			
finder_tUniqRow_1.date = row2.date;	
finder_tUniqRow_1.hashCodeDirty = true;
if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
		KeyStruct_tUniqRow_1 new_tUniqRow_1 = new KeyStruct_tUniqRow_1();

		
new_tUniqRow_1.date = row2.date;
...
Var.Annee = TalendDate.getPartOfDate("YEAR",row3.date) ;
Var.Numero_Mois = TalendDate.getPartOfDate("MONTH",row3.date) + 1 ;
Var.Mois_Annee = TalendDate.formatDate("yyyy-MMM",row3.date) ;
Var.Numero_Jour_Semaine = TalendDate.getPartOfDate("DAY_OF_WEEK",row3.date) ;
Var.Numero_Semaine_Annee = TalendDate.getPartOfDate("WEEK_OF_YEAR",row3.date) ;
Var.Trimestre = TalendDate.getPartOfDate("MONTH",row3.date)/3 + 1 ;
Var.Semestre = TalendDate.getPartOfDate("MONTH",row3.date)/6 + 1 ;// ###############################
        // ###############################
        // # Output tables
...
out1_tmp.Mois_Annee = StringHandling.UPCASE(Var.Mois_Annee) ;
out1_tmp.Numero_Jour_Semaine = Var.Numero_Jour_Semaine ;
...
out1_tmp.Numero_Semaine_Annee = "Semaine"+" "+Var.Numero_Semaine_Annee ;
 					    ...
 					    boolean forceLooprow4 = false;
 							...
 							row4Struct row4ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
                        		    		    ...
                        		    		    row4HashKey.date = out1.date  == null ? null : new java.util.Date(out1.date .getTime());
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_2 ) {
out2_tmp.id_temps = out1.ID_Temp ;
out2_tmp.date = out1.date ;
out2_tmp.annee = out1.Annee ;
out2_tmp.numero_mois = out1.Numero_Mois ;
out2_tmp.mois = out1.Nom_Mois ;
out2_tmp.annee_mois = out1.Mois_Annee ;
out2_tmp.numero_jours_semaine = out1.Numero_Jour_Semaine ;
out2_tmp.jour_semaine = out1.Jour_Semaine ;
out2_tmp.semaine = out1.Numero_Semaine_Annee ;
out2_tmp.trimestre = out1.Trimestre ;
out2_tmp.semestre = out1.Semestre ;
out2 = out2_tmp;
...
if(out2 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    pstmt_tDBOutput_1.setInt(1, out2.id_temps);
            ...
            if(checkCount_tDBOutput_1 > 0) {
                        if(out2.date != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(1, new java.sql.Timestamp(out2.date.getTime()));
} else {
...
} else {pstmtUpdate_tDBOutput_1.setInt(2, out2.annee);
}

                        if(out2.numero_mois == null) {
pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(3, out2.numero_mois);
}

                        if(out2.mois == null) {
pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(4, out2.mois);
}

                        if(out2.annee_mois == null) {
pstmtUpdate_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(5, out2.annee_mois);
}

                        if(out2.numero_jours_semaine == null) {
pstmtUpdate_tDBOutput_1.setNull(6, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(6, out2.numero_jours_semaine);
}

                        if(out2.jour_semaine == null) {
pstmtUpdate_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(7, out2.jour_semaine);
}

                        if(out2.semaine == null) {
pstmtUpdate_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(8, out2.semaine);
}

                        if(out2.trimestre == null) {
pstmtUpdate_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(9, out2.trimestre);
}

                        if(out2.semestre == null) {
pstmtUpdate_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(10, out2.semestre);
}

                        pstmtUpdate_tDBOutput_1.setInt(11 + count_tDBOutput_1, out2.id_temps);
...
globalMap.put("tDBOutput_1_ERROR_MESSAGE",e.getMessage());
                    ...
                    whetherReject_tDBOutput_1 = true;
                        ...
                        pstmtInsert_tDBOutput_1.setInt(1, out2.id_temps);

                        if(out2.date != null) {
pstmtInsert_tDBOutput_1.setTimestamp(2, new java.sql.Timestamp(out2.date.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_1.setInt(3, out2.annee);
}

                        if(out2.numero_mois == null) {
pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(4, out2.numero_mois);
}

                        if(out2.mois == null) {
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(5, out2.mois);
}

                        if(out2.annee_mois == null) {
pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(6, out2.annee_mois);
}

                        if(out2.numero_jours_semaine == null) {
pstmtInsert_tDBOutput_1.setNull(7, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(7, out2.numero_jours_semaine);
}

                        if(out2.jour_semaine == null) {
pstmtInsert_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(8, out2.jour_semaine);
}

                        if(out2.semaine == null) {
pstmtInsert_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(9, out2.semaine);
}

                        if(out2.trimestre == null) {
pstmtInsert_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(10, out2.trimestre);
}

                        if(out2.semestre == null) {
pstmtInsert_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(11, out2.semestre);
}
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:iop1JQdB4iy4nb/GYENw8o81GFyaw8SNiEfVHpkQfNHiG7qIDus=");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row5";
		...
		int tos_count_tAdvancedHash_row5 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row3,row5) outputs:(out1)
 ...
 */
	...
	final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:cDvu9KpIIWUitNYBe7PqTiEKTwa+fmY+rtIOmksv0clKSnbTxJE=");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Alimentation_Dim_TEMPS.class.getClassLoader().getResourceAsStream("data_pipeline_leuk/alimentation_dim_temps_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     191236 characters generated by Talend Open Studio for Big Data 
 *     on the 28 novembre 2024 à 13:11:07 GMT
 ************************************************************************************************/