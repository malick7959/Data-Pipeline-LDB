...
package data_pipeline_leuk.alimentation_fait_chef_de_quart_0_1;
...
public static class Update_DataStruct implements routines.system.IPersistableRow<Update_DataStruct> {
    final static byte[] commonByteArrayLock_DATA_PIPELINE_LEUK_Alimentation_FAIT_CHEF_DE_QUART = new byte[0];
    static byte[] commonByteArray_DATA_PIPELINE_LEUK_Alimentation_FAIT_CHEF_DE_QUART = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DATA_PIPELINE_LEUK_Alimentation_FAIT_CHEF_DE_QUART) {
...
public static class out3Struct implements routines.system.IPersistableRow<out3Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DATA_PIPELINE_LEUK_Alimentation_FAIT_CHEF_DE_QUART.length) {
				if(length < 1024 && commonByteArray_DATA_PIPELINE_LEUK_Alimentation_FAIT_CHEF_DE_QUART.length == 0) {
   					commonByteArray_DATA_PIPELINE_LEUK_Alimentation_FAIT_CHEF_DE_QUART = new byte[1024];
				} else {
   					commonByteArray_DATA_PIPELINE_LEUK_Alimentation_FAIT_CHEF_DE_QUART = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DATA_PIPELINE_LEUK_Alimentation_FAIT_CHEF_DE_QUART, 0, length);
			strReturn = new String(commonByteArray_DATA_PIPELINE_LEUK_Alimentation_FAIT_CHEF_DE_QUART, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_DATA_PIPELINE_LEUK_Alimentation_FAIT_CHEF_DE_QUART, 0, length);
			strReturn = new String(commonByteArray_DATA_PIPELINE_LEUK_Alimentation_FAIT_CHEF_DE_QUART, 0, length, utf8Charset);
		}
		return strReturn;
	}
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:x6mr+c1dLUvPSFSfqho/HH2Zzn/iDYUGRcwxBOWbgYKAwWqvty3JK6vU");
...
out1_tmp.Prix__Gambie = row2.PrixGambie ;
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:H/+8K8uOAHuroVlazEZNRfonQY/rPKxVlqL2COoPqlxVsgly+fY=");
...
String dbUser_tDBOutput_2 = null;
	...
	final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:+oV8pax+b/WLv3/WdoEycA0b5AEEVnnmBVGW2ovWF91BaurN9zM=");
...
out3_tmp.Pertes = (double) Math.round(out2.Pertes * 100.0) / 100.0;
out3_tmp.CANTTC = (double) Math.round(Var.CANTTC * 100.0) / 100.0 ;
...
out4_tmp.CAHT = (double) Math.round(Var.CAHT * 100.0) / 100.0 ;
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:FfjtxcG90NoUJLPopnAxpkTYmWPkLf/xXyT4GA+1MfDdPETHgVc=");
 ...
 */
	...
	final String decryptedPassword_tDBInput_4 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:DASqAnoNz75stFdbHTPlJYGxgEjksu5UMi653lvgMdEhdzPcppE=");
 ...
 */
	...
	final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:4pP94ZzeSPm1d/oEy4Pc1XTHa+9BwnjYF4MkTB9Gbk1SjAFHsoU=");
 ...
 */
	...
	final String decryptedPassword_tDBInput_5 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:H5YGlimMjTFSCq3GW2hK+FUy7mAYJ6WZEMuT6s3d94sPBfrtjUs=");
...
+"e\"  between CURRENT_DATE - INTERVAL '4 day' and CURRENT_DATE - INTERVAL '1 day'\nORDER BY    \"public\".\"Fait_CDQ\".\""
+"id_faitcdq\" asc";
 ...
 */
	...
	final String decryptedPassword_tDBInput_7 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:No0YxlrLAGIkepT0OkNwnH1Y8BXn5A22joif6Ez7XCUocmVm6DE=");
 ...
 */
	...
	final String decryptedPassword_tDBInput_6 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:aVPcLOKdIqBheXPruKJv1Mn46+wE6z/wGurJdvsEv8lf9hOYk+s=");
...
public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
    ...
    public String loopKey;
			    ...
			    public Double PrixGambie;

				public Double getPrixGambie () {
					return this.PrixGambie;
				}
	...
	public void copyDataTo(row2Struct other) {
		...
		other.sku_commcare = this.sku_commcare;
	            ...
	            other.PrixGambie = this.PrixGambie;
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.PrixGambie = null;
           				} else {
           			    	this.PrixGambie = dis.readDouble();
           				}
			...
			int length = 0;
			            ...
			            length = objectIn.readByte();
           				if (length == -1) {
           			    	...
           			    	this.PrixGambie = objectIn.readDouble();
           				}
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
					...
					writeInteger(this.Prix__Mali_Guinee, dos, oos);
						...
						if(this.PrixGambie == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.PrixGambie);
		            	}
                ...
                try {
					...
					writeInteger(this.Prix__Mali_Guinee, dos, objectOut);
						...
						if(this.PrixGambie == null) {
							...
							objectOut.writeByte(0);
							objectOut.writeDouble(this.PrixGambie);
		            	}
    ...
    public String toString() {
		...
		sb.append(",PrixGambie="+String.valueOf(PrixGambie));
	    sb.append("]");
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:lVZwEysIGblbCkzJv0g1nqlTvjhVqk1NTTMrkg==");
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Prix__Mali_Guinee";

				row2.Prix__Mali_Guinee = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "PrixGambie";

				row2.PrixGambie = ParserUtils.parseTo_Double(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row2.PrixGambie = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
...
if(row2 != null) { 
	...
	currentComponent="tAdvancedHash_row2";
				...
				row2_HashRow.PrixGambie = row2.PrixGambie;
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:7cUk5B5kFLybG/dwRehkLTLhQFncSbWJCDAweVWr0knWIyUA7nxrWxMx");
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:DuUumPW1GM7Z6KQm9hG5qN6JaGuHEby4iURic5eq/6oNO9iMIxM=");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Alimentation_FAIT_CHEF_DE_QUART.class.getClassLoader().getResourceAsStream("data_pipeline_leuk/alimentation_fait_chef_de_quart_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     524895 characters generated by Talend Open Studio for Big Data 
