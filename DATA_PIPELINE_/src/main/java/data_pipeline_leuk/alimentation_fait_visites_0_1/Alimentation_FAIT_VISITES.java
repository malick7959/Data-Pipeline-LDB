...
package data_pipeline_leuk.alimentation_fait_visites_0_1;
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:KqZstRkpNlg+WU6p09XXUoGpt092CTegAAGxF7LLQo+QQZUWYxhtcpCp");
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:FsLL9TxqKCyEEk2meYdAEaEjOfaY3rTYOXGpgo5LJmpQGfQ+y5o=");
...
public static class out7Struct implements routines.system.IPersistableRow<out7Struct> {
    final static byte[] commonByteArrayLock_DATA_PIPELINE_LEUK_Alimentation_FAIT_VISITES = new byte[0];
    static byte[] commonByteArray_DATA_PIPELINE_LEUK_Alimentation_FAIT_VISITES = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DATA_PIPELINE_LEUK_Alimentation_FAIT_VISITES) {
...
public static class out8Struct implements routines.system.IPersistableRow<out8Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DATA_PIPELINE_LEUK_Alimentation_FAIT_VISITES.length) {
				if(length < 1024 && commonByteArray_DATA_PIPELINE_LEUK_Alimentation_FAIT_VISITES.length == 0) {
   					commonByteArray_DATA_PIPELINE_LEUK_Alimentation_FAIT_VISITES = new byte[1024];
				} else {
   					commonByteArray_DATA_PIPELINE_LEUK_Alimentation_FAIT_VISITES = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DATA_PIPELINE_LEUK_Alimentation_FAIT_VISITES, 0, length);
			strReturn = new String(commonByteArray_DATA_PIPELINE_LEUK_Alimentation_FAIT_VISITES, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_DATA_PIPELINE_LEUK_Alimentation_FAIT_VISITES, 0, length);
			strReturn = new String(commonByteArray_DATA_PIPELINE_LEUK_Alimentation_FAIT_VISITES, 0, length, utf8Charset);
		}
		return strReturn;
	}
 ...
 */
	...
	final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:g9SLMQYuqh3K7M+YdTqspGvsO2nHIToUlOidVyf+1/dJwPj+T3e3YD6j");
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:YolX8G0f8wT71Mgspd4FWQpTXptgaH9c6D4WxVpBpfppLRE7CMY=");
...
String dbUser_tDBOutput_2 = null;
	...
	final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:At+saAbxP9MxlkNfqmTGOl2UUy/6wyvAnX9l1129pDTcqb+P9IQ=");
 ...
 */
	...
	final String decryptedPassword_tDBInput_4 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:WHh/8ju+uNaxzmNm9Pdsa4KUOjhyUVSQH3yY61Afg8YHE0k/NlE=");
 ...
 */
	...
	final String decryptedPassword_tDBInput_6 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:e6yVKVi9JGQAMizJSr7qAhj4PKchsjNHQ5nV8UEIdFZLqeCOQLYxD5Qj");
 ...
 */
	...
	final String decryptedPassword_tDBInput_5 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:Q6IjTd83ubB391tZWTABkJwDM/SLrzz0rpDC+AqaPwWHD7XCFM+g9Mop");
...
+"te Between CURRENT_DATE - INTERVAL ' 2 DAY ' and  CURRENT_DATE - INTERVAL ' 1 DAY '\n) pdv_data\n-- Jointure avec le com"
+"ptage mensuel des PDV\nJOIN pdv_monthly_count pmc\n    ON pdv_data.sector = pmc.sector\n    AND TO_CHAR(pdv_data.date, '"
+"YYYY-MM-01') = pmc.mois_annee  -- Associer les PDV du mois\nORDER BY pdv_data.date;";
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:WVxW9bD2C0XQspD+Nugn6ppit2X9RqvyCVlXUu0JudM9CmM9g+w=");
 ...
 */
	...
	final String decryptedPassword_tDBInput_7 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:haxrKf+0FT4FIM2JegkVTVddF0jGtsYRBMmSyx7K36DpSE8n9uA=");
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:mNKV2AyZofl89JkIqNOl3RgwbRZd5kVr/64afhjuhPvldQvPDOw=");
 ...
 */
	...
	final String decryptedPassword_tDBInput_8 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:yqA/cIzPNc2OoIa5uWfVJvJG1SaICTUdSkU2xLZAh04q8XTeKic=");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Alimentation_FAIT_VISITES.class.getClassLoader().getResourceAsStream("data_pipeline_leuk/alimentation_fait_visites_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     447278 characters generated by Talend Open Studio for Big Data 
