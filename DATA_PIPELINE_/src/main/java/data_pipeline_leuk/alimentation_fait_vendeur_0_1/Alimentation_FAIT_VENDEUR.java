...
package data_pipeline_leuk.alimentation_fait_vendeur_0_1;
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:MEBnJ/YDGAUF9W7R18VGx+YQwxG6FepLT+d+QDvymdUm7jr+a7udAu4N");
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:GWiSXz/xD5yENQqoWb/o2Sg/3t3L/qee8yrOZTV7tVp1FKOGV7c=");
...
public static class out8Struct implements routines.system.IPersistableRow<out8Struct> {
    final static byte[] commonByteArrayLock_DATA_PIPELINE_LEUK_Alimentation_FAIT_VENDEUR = new byte[0];
    static byte[] commonByteArray_DATA_PIPELINE_LEUK_Alimentation_FAIT_VENDEUR = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DATA_PIPELINE_LEUK_Alimentation_FAIT_VENDEUR.length) {
				if(length < 1024 && commonByteArray_DATA_PIPELINE_LEUK_Alimentation_FAIT_VENDEUR.length == 0) {
   					commonByteArray_DATA_PIPELINE_LEUK_Alimentation_FAIT_VENDEUR = new byte[1024];
				} else {
   					commonByteArray_DATA_PIPELINE_LEUK_Alimentation_FAIT_VENDEUR = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DATA_PIPELINE_LEUK_Alimentation_FAIT_VENDEUR, 0, length);
			strReturn = new String(commonByteArray_DATA_PIPELINE_LEUK_Alimentation_FAIT_VENDEUR, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_DATA_PIPELINE_LEUK_Alimentation_FAIT_VENDEUR, 0, length);
			strReturn = new String(commonByteArray_DATA_PIPELINE_LEUK_Alimentation_FAIT_VENDEUR, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DATA_PIPELINE_LEUK_Alimentation_FAIT_VENDEUR) {
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:+j6cWgWN5n+3LLRY6hdcxavIDwH5+Q/5A7NrWK9I+TL7X1HFYC82aEjt");
...
line_tmp.Prix_Mali_Guinee = row2.Prix_Mali_Guinee ;
line_tmp.Prix__Gambie = row2.Prix__Gambie ;
...
out1_tmp.CANTTC = (double) Math.round(Var.CANTTC * 100.0) /100.0;
out1_tmp.Pertes =  (double) Math.round(Var.Pertes  * 100.0)/100.0;
...
out7_tmp.CANTTC = (double) Math.round(Var.CANTTC * 100.0) /100.0;
out7_tmp.Pertes =  (double) Math.round(Var.Pertes  * 100.0)/100.0;
...
Var.CANHT = (out1.nompilier.equals("LF")) ? Integer.valueOf((int)out1.CANTTC) : Integer.valueOf((int)Math.round(out1.CANTTC/1.18)) ;
...
out2_tmp.CANHT = (double) Math.round(Var.CANHT * 100.0)/100.0 ;
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:nbIr281BHR3pYI/JLK89/edbmaXAcCTa+TRH9tjDtwi99Q0kmw0=");
...
String dbUser_tDBOutput_2 = null;
	...
	final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:60i2SR0Q29W2SXnEVi3aylb8s35zkPMqbGTwXxki7u4QG7CntZ0=");
...
public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
	...
	public void copyDataTo(row2Struct other) {
		...
		other.sku_commcare = this.sku_commcare;
	            other.Prix_Mali_Guinee = this.Prix_Mali_Guinee;
	            other.Prix__Gambie = this.Prix__Gambie;
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.Prix_Mali_Guinee = readInteger(dis,ois);
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
						...
						this.Prix_Mali_Guinee = readInteger(dis,objectIn);
					
			            length = objectIn.readByte();
           				if (length == -1) {
           	    			this.Prix__Gambie = null;
           				} else {
           			    	this.Prix__Gambie = objectIn.readDouble();
           				}
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
					...
					writeInteger(this.Prix_Mali_Guinee, dos, oos);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					writeInteger(this.Prix_Mali_Guinee, dos, objectOut);
					
						if(this.Prix__Gambie == null) {
							objectOut.writeByte(-1);
						} else {
							objectOut.writeByte(0);
							objectOut.writeDouble(this.Prix__Gambie);
		            	}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row2";
		...
		int tos_count_tAdvancedHash_row2 = 0;
			   		...
			   		// source node:tFileInputExcel_1 - inputs:(after_tDBInput_1) outputs:(row2,row2) | target node:tAdvancedHash_row2 - inputs:(row2) outputs:()
			   		// linked node: tMap_1 - inputs:(row1,row2,row3) outputs:(line)
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:0TZGmJsKDk4R9L3OaUbOotz6R22qXZdIy57RgA==");
		...
		Object source_tFileInputExcel_1 = "C:/Users/malick.diouf/Desktop/Catalogue produit.xlsx";
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				curColName_tFileInputExcel_1 = "sku_commcare";

				row2.sku_commcare = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Prix_Mali_Guinee";

				row2.Prix_Mali_Guinee = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row2.Prix_Mali_Guinee = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Prix__Gambie";

				row2.Prix__Gambie = ParserUtils.parseTo_Double(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row2.Prix__Gambie = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
...
if(row2 != null) { 
	...
	currentComponent="tAdvancedHash_row2";
				...
				row2_HashRow.Prix_Mali_Guinee = row2.Prix_Mali_Guinee;
				
				row2_HashRow.Prix__Gambie = row2.Prix__Gambie;
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:f+JK4M5jZgyrlMNcIc6KXP5rEwX+DJhcTypPtSvV13kN3LSVnEs=");
 ...
 */
	...
	final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:krNAfHxdEXBeutGwq9V2UdchQ8pgbNQ0izxf8kiI26Pdlkno9Fg=");
 ...
 */
	...
	final String decryptedPassword_tDBInput_4 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:ula2X19dYu/zOPUkzrw9aAe1CDemgznUf5j/V2B+dvdUTuCRiwI=");
 ...
 */
	...
	final String decryptedPassword_tDBInput_5 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:HKaainsR+OjihMRVGg7zj6TmsP45wHlDhuyVbH1gCFaUe6J+s5o=");
 ...
 */
	...
	final String decryptedPassword_tDBInput_6 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:OM452HhGZPQVqU6ES41gHQb9rC7DOGnhMjAW4tFzSekIXimS+Iw=");
 ...
 */
	...
	final String decryptedPassword_tDBInput_7 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:UKFA6fG0H5xTkIWG3MaP5LvLJmB3VvJhpFIcXDwu/ThuOnRW/e0=");
 ...
 */
	...
	final String decryptedPassword_tDBInput_8 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:+GwPH86MpVYTZwEEHMY7Feg9iFgJqaM9njsNSig3iJfXDi/csf0=");
 ...
 */
	...
	final String decryptedPassword_tDBInput_9 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:TE/Gt9EkIy5Bems+vTlExN0Eyt1wmML5XJIOEsrMFSEpxMDsN2CoS3t+");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Alimentation_FAIT_VENDEUR.class.getClassLoader().getResourceAsStream("data_pipeline_leuk/alimentation_fait_vendeur_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     617764 characters generated by Talend Open Studio for Big Data 
 *     on the 28 novembre 2024 à 13:11:08 GMT
 ************************************************************************************************/