...
package data_pipeline_leuk.alimentation_dim_point_de_ventes_0_1;
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:D+mMc80BnaD2eWar9v38RTRjwtxW0R2tadOoa6lmN1oanY0DWHE7VQUW");
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:QTYT7mGG3KMJKiygTVu4mMyykHckZNRx7nH0/tLwfBC5TInhNtY=");
...
public static class out3Struct implements routines.system.IPersistableRow<out3Struct> {
    final static byte[] commonByteArrayLock_DATA_PIPELINE_LEUK_Alimentation_Dim_Point_De_Ventes = new byte[0];
    static byte[] commonByteArray_DATA_PIPELINE_LEUK_Alimentation_Dim_Point_De_Ventes = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DATA_PIPELINE_LEUK_Alimentation_Dim_Point_De_Ventes.length) {
				if(length < 1024 && commonByteArray_DATA_PIPELINE_LEUK_Alimentation_Dim_Point_De_Ventes.length == 0) {
   					commonByteArray_DATA_PIPELINE_LEUK_Alimentation_Dim_Point_De_Ventes = new byte[1024];
				} else {
   					commonByteArray_DATA_PIPELINE_LEUK_Alimentation_Dim_Point_De_Ventes = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DATA_PIPELINE_LEUK_Alimentation_Dim_Point_De_Ventes, 0, length);
			strReturn = new String(commonByteArray_DATA_PIPELINE_LEUK_Alimentation_Dim_Point_De_Ventes, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_DATA_PIPELINE_LEUK_Alimentation_Dim_Point_De_Ventes, 0, length);
			strReturn = new String(commonByteArray_DATA_PIPELINE_LEUK_Alimentation_Dim_Point_De_Ventes, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DATA_PIPELINE_LEUK_Alimentation_Dim_Point_De_Ventes) {
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:4XWoZwGw2GOgk9THsG0kur+iypXlNPZVIbzniDXET12dD0aoqtefPtBn");
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:2tyRck045A2kr8fbmdAa1gGRzbbAjzRhlv+BnPDJYpYKoDQv4Vk=");
...
String dbUser_tDBOutput_2 = null;
	...
	final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:aWtGv85Hy6JV+geT3ezz0VwmDtHt4w2plCXwVOfic+NoDIOj1RA=");
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:BJvpdjIG2Z/P2oYDkYEZVmdSl4GCQrTrjlawhnhmNArmkWyRK0oIOSZO");
 ...
 */
	...
	final String decryptedPassword_tDBInput_4 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:Z47y8YVkBF2yaY76rwmcCH6tvz5qvK3Ub6KVhir3uNhCqB0qcvCB7D5t");
 ...
 */
	...
	final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:phzZch6Gh1npsKx4ky09BGdjGdAbVAL+gGJM3MfmGnFAh0OwwHn4cxMh");
 ...
 */
	...
	final String decryptedPassword_tDBInput_5 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:wrCNrLVz7gJVuyzKcErCqEd6D6nqTGTHZ0dh3p722tkhMr3VYy+aqDn4");
 ...
 */
	...
	final String decryptedPassword_tDBInput_6 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:RqFivZi1eaGoY1NYc4XFpycDp0uV/XxTna8uEXRQeR4Mnkg0tvU=");
 ...
 */
	...
	final String decryptedPassword_tDBInput_7 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:fXB9VI9IOT+7UXpvdO40Xh6rXCes+iKKUaILT1v2ByUYdqR4i/Q=");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Alimentation_Dim_Point_De_Ventes.class.getClassLoader().getResourceAsStream("data_pipeline_leuk/alimentation_dim_point_de_ventes_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     599163 characters generated by Talend Open Studio for Big Data 
