...
package data_pipeline_leuk.alimentation_dim_geographie_0_1;
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:3KAenKqbD0VW8G2ou1ppVk9Ygpg/rHFOKXG/jOdIh+ATYcezi8Nj5van");
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:231HjypkHXdqba3dUa3vLUgqBmz1c31baawPb0c6Zy1FCPslq6A=");
...
public static class Update_Line_ExistingStruct implements routines.system.IPersistableRow<Update_Line_ExistingStruct> {
    final static byte[] commonByteArrayLock_DATA_PIPELINE_LEUK_Alimentation_Dim_Geographie = new byte[0];
    static byte[] commonByteArray_DATA_PIPELINE_LEUK_Alimentation_Dim_Geographie = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DATA_PIPELINE_LEUK_Alimentation_Dim_Geographie.length) {
				if(length < 1024 && commonByteArray_DATA_PIPELINE_LEUK_Alimentation_Dim_Geographie.length == 0) {
   					commonByteArray_DATA_PIPELINE_LEUK_Alimentation_Dim_Geographie = new byte[1024];
				} else {
   					commonByteArray_DATA_PIPELINE_LEUK_Alimentation_Dim_Geographie = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DATA_PIPELINE_LEUK_Alimentation_Dim_Geographie, 0, length);
			strReturn = new String(commonByteArray_DATA_PIPELINE_LEUK_Alimentation_Dim_Geographie, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_DATA_PIPELINE_LEUK_Alimentation_Dim_Geographie, 0, length);
			strReturn = new String(commonByteArray_DATA_PIPELINE_LEUK_Alimentation_Dim_Geographie, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DATA_PIPELINE_LEUK_Alimentation_Dim_Geographie) {
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:ZXCQwKk9uDNGgAQVSjVhPwWccb4HhSS15NTjPDA6powNvgqdM5olO2nV");
...
String dbUser_tDBOutput_2 = null;
	...
	final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:KASIbn0IOFHCGRzr7e0FYgzdFAnkeyD7s7hSD1B2i+pkTbB2q/U=");
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:tVBHUf/oDa0ggPPjwfwSgaHv0VVKh+G17ASPuWLN82EOjlrDrrM=");
...
if(dbschema_tDBOutput_3 == null || dbschema_tDBOutput_3.trim().length() == 0) {
	tableName_tDBOutput_3 = ("Dim_Geographie");
} else {
	tableName_tDBOutput_3 = dbschema_tDBOutput_3 + "\".\"" + ("Dim_Geographie");
}
...
String dbUser_tDBOutput_3 = null;
	...
	final String decryptedPassword_tDBOutput_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:N0jzwv6VaB8gelKn8GwC5BX3s4td7KcH6oF8LvUgr/ED62G1G9A=");
...
int count_tDBOutput_3=0;
	    String update_tDBOutput_3 = "UPDATE \"" + tableName_tDBOutput_3 + "\" SET \"region_commercial\" = ?,\"zone_supervision\" = ?,\"secteur\" = ?,\"hub\" = ?,\"pays\" = ? WHERE \"id_secteur\" = ?";
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:PXngDelAkybwjQlRjR1tMqhA1s5WPRhE7J4i+g==");
		...
		Object source_tFileInputExcel_1 = "C:/Users/malick.diouf/Desktop/Secteur Talend.xlsx";
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				curColName_tFileInputExcel_1 = "id_secteur";

				row6.id_secteur = ParserUtils.parseTo_long(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row6.id_secteur = 0;
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "region_commercial";

				row6.region_commercial = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "zone_supervision";

				row6.zone_supervision = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "secteur";

				row6.secteur = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row6.secteur = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "hub";

				row6.hub = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row6.hub = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row6.pays = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row6.pays = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
...
out3_tmp.region_commercial = row6.region_commercial ;
out3_tmp.zone_supervision = row6.zone_supervision ;
out3_tmp.secteur = row6.secteur ;
out3_tmp.hub = row6.hub ;
out3_tmp.pays = row6.pays ;
out3 = out3_tmp;
// ###############################
...
if(out3 != null) { 
	...
	currentComponent="tDBOutput_3";
        ...
        whetherReject_tDBOutput_3 = false;
                    if(out3.region_commercial == null) {
pstmt_tDBOutput_3.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(1, out3.region_commercial);
}

                    if(out3.zone_supervision == null) {
pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(2, out3.zone_supervision);
}

                    if(out3.secteur == null) {
pstmt_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(3, out3.secteur);
}

                    if(out3.hub == null) {
pstmt_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(4, out3.hub);
}

                    if(out3.pays == null) {
pstmt_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(5, out3.pays);
}

                    pstmt_tDBOutput_3.setLong(6 + count_tDBOutput_3, out3.id_secteur);
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:GsCcw8Q5oN4Tuzj1vcjy7KAiguBnn2llnP04ry0f9opamTzTB88=");
 ...
 */
	...
	final String decryptedPassword_tDBInput_7 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:+KPuZhpUVhcvMZOdcbZKwaZ2b6wJe5KVNZMXLpcsJ1jUsQRaECY=");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Alimentation_Dim_Geographie.class.getClassLoader().getResourceAsStream("data_pipeline_leuk/alimentation_dim_geographie_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     423290 characters generated by Talend Open Studio for Big Data 
 *     on the 28 novembre 2024 à 13:11:06 GMT
 ************************************************************************************************/